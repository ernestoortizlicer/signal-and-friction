...
export const ADMIN_MODULES: readonly AdminModuleDefinition[] = [
  ...
  },
  {
    ...
    aliases: ["/admin/prospecting"],
    purpose: "Move a qualified company from discovery to paid diagnostic work.",
    sourceOfTruth: "clients + beta_projects + prospect_candidates; commercial truth comes from offer-catalog and payment state.",
    owns: "Prospecting, qualification, pipeline stage, outreach and commercial progression.",
    receives: ["Prospect candidates", "Contact evidence", "Payment state", "Commercial offer policy"],
    produces: ["Qualified opportunities", "Project stage transitions", "Paid-work handoff"],
    surfaces: [
