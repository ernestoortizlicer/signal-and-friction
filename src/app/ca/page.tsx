...
export const metadata: Metadata = {
  title: "Signal & Friction — Canada B2B SaaS Diagnostic",
  description: "Evidence-ranked behavioral diagnosis for Canadian B2B SaaS and digital-service teams. 72h async delivery.",
  alternates: {
    canonical: "https://signal-and-friction.com/ca",
    languages: {
...
export default function Page() {
  return <MarketLanding countryCode="CA" />;
}
