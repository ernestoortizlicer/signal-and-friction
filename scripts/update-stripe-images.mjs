/**
 * update-stripe-images.mjs
 * Sets product images on all 13 Stripe products using public Cloudflare Pages URLs.
 * Usage: node scripts/update-stripe-images.mjs
 */
...
const BASE_URL = "https://signal-and-friction.pages.dev/product-icons";
...
async function run() {
  console.log("Updating Stripe product images with public CDN URLs...\n");
