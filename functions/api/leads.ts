...
export const onRequestPost = async ({
  ...
  // Lead ingestion records observable intake only. It must never trigger a
  // behavioral diagnosis. Scanner output may be supplied by the client for
  // separate evidence workflows, but no LLM diagnosis is invoked or persisted
  // here. Final diagnostic authority belongs to the assigned human analyst.
