...
// The 7 judgment fields plus loom_script are the only writable fields here —
// evidence, technical_signals, target_url, domain, scanned_at, client_id,
// prospect_candidate_id, and loom_script_generated_at are set once at
// generation and are immutable here. Regenerate to refresh measured data;
// never hand-edit it. loom_script itself IS meant to be hand-revised after
// generation — that's the point of exposing it here — but it's never
// generated by this endpoint, only by scaffolds/generate-loom.ts.
